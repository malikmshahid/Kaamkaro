    ...
    <>
      ...
      <main className="flex-1 max-w-xl mx-auto w-full px-6 py-16">
        ...
        <p className="text-ink/60 mb-8">
          Jitni tafseel dein ge, utna behtar match milega.
        </p>

        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm mb-1">Kaam ka Title</label>
            <input
              className="w-full border border-line rounded-lg px-4 py-2.5 bg-white focus:outline-none focus:ring-2 focus:ring-green-700"
              placeholder="e.g. Lahore mein package pickup"
              value={form.title}
          ...
          <div>
            <label className="block text-sm mb-1">Tafseel</label>
            <textarea
              ...
              placeholder="Kaam ke baare mein poori detail likhein..."
          ...
          <div>
            ...
            <input
              className="w-full border border-line rounded-lg px-4 py-2.5 bg-white focus:outline-none focus:ring-2 focus:ring-green-700"
              placeholder="Lahore, Karachi, Online..."
              value={form.city}
